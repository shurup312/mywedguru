...
class m150830_090003_AddTable_Person extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable($this->tableName, [
            ...
            'mob_phone'    => $this->timestamp().' NULL DEFAULT NULL COMMENT "Мобильный телефон"',
            'phone'        => $this->timestamp().' NULL DEFAULT NULL COMMENT "Домашний телефон"',
            'address'      => $this->timestamp().' NULL DEFAULT NULL COMMENT "Адрес"',
            'email'        => $this->timestamp().' NULL DEFAULT NULL COMMENT "E-mail"',
