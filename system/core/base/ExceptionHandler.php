...
class ExceptionHandler extends Object
{
	...
	public function handler(Exception $e)
	{
		...
		if(App::getConfig()['debug']) {
			$this->render('exception.php', ['exception'=>$e, 'errorFile'=>$errorFile, 'errorStack'=>$errorStack]);
		} else {
			$this->render('exceptionProduction.php', ['exception'=>$e, 'errorFile'=>$errorFile, 'errorStack'=>$errorStack]);
		}
