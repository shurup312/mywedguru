...
class InArray extends AbstractValidator
{
    ...
    protected $messageTemplates = array(
        self::NOT_IN_ARRAY => 'Значение не входит в список разрешенных',
    );
     ...
     *
     * @return mixed
     * @throws Exception if haystack option is not set
     */
    public function getHaystack()
    {
        if ($this->haystack === null) {
            throw new Exception('Не задан список допустимых значений для валидатора.');
        }
