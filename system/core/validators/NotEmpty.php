...
class NotEmpty extends AbstractValidator
{
	...
	protected $messageTemplates = [
		self::IS_EMPTY => "Значение обязательно для заполнения и не может быть пустым",
		self::INVALID  => "Получен неверный тип данных. Допустимы типы: строка, число, число с плавающей точкой, массив или булево значение",
	];
	/**
