...
class StringLength extends AbstractValidator
{
    ...
    protected $messageTemplates = [
        self::INVALID   => "Неверный формат данных, только строки допустимы",
        self::TOO_SHORT => "Длина значение не может быть меньше %min%",
        self::TOO_LONG  => "Длина значение не может быть больше %max%",
    ];
