			...
			<div class="widget-body" style="padding: 10px">
				<? if (@$genPass): ?>
					<div class="row" style="padding-bottom: 25px; padding-top: 10px">
						<div class="col-lg-4">Временный пароль:</div>
						<div class="col-lg-8"><?= $genPass ?></div>
					</div>
				<? endif ?>
				<? if (!isset($ok)): ?>
					<form name="change-password" method="post" action="changepassword">
						...
						<div class="row">
							...
							<div class="col-lg-8">
								<input class="form-control" type="password" name="new_password2" ng-model="pass2" required="">
