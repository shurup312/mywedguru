...
function quickBox() {
	var data = {
		"folder": 		"templates/admin/js/quickbox", // folder
	...
	function attachCSS() { // attach css
		...
		link.rel  = "stylesheet";
		link.type = "text/css";
		link.href = data["folder"]+"/css/qb.css";
		link.media = "all";
	...
	$(document).delegate("a.quickbox", "click", function() { // show img
		...
		var e = {
			"href": $(this).attr("href"),
			"title": $(this).attr("text-img") ? $(this).attr("text-img") : $(this).attr("alt")
		}
		showIMG(e);
		return false;
	});
