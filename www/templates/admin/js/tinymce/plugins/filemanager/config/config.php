...
{ die ();}
if ($_SESSION['USER']['rights']!=0x7FFFFFFF and $_SESSION['USER']['rights']!=0x7FFFFFFE)
{
    var_dump($_SESSION);
    echo 0x7FFFFFFF;
    die ('НЕТ ПРАВ');
...
$upload_dir = '/public/file_manager/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../../../public/file_manager/sourse/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../../../public/file_manager/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
//die(__DIR__);
// OPTIONAL SECURITY
...
$access_keys = array('myPrivateKey','someo551515151neElseKey');
